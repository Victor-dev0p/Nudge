...
import { Target, Mail, Lock, User, AlertCircle, Loader2, CheckCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Build the habit. Hit your targets.</p>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-xl rounded-2xl shadow-2xl p-8 border border-white/20">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3 bg-white/5 border border-white/20 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
          ...
          <Link
            href="/login"
            className="block w-full text-center py-3 px-6 border border-white/20 rounded-xl text-white font-semibold hover:bg-white/5 transition-all"
          >
            Sign In
          </Link>
        </div>
